package com.loanprocessingsystem.LoanApplicationServiceTest;
...
import com.loanprocessingsystem.service.ILoanApplicationServiceImpl;
...
public class LoanApplicationServiceTest {
	...
	void testaddLoanApplication() {
		...
		input.setLoanVerificationApproval(true);
		input.setLoanVerificationApproval(false);
	...
	void deleteLoanApplication() throws InvalidLoanApplicationException {
		...
		output.setLoanVerificationApproval(true);
		output.setLoanVerificationApproval(false);
