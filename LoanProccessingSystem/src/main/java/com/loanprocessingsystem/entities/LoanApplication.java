package com.loanprocessingsystem.entities;
...
public class LoanApplication {
	...
	private boolean laonVerificationApproval;
	...
	public LoanApplication(long applicationId, LocalDate applicationDate, Customer customer, double loanAppliedAmount,
			double loanApprovedAmount,  boolean loanVerificationApproval,
		...
		this.laonVerificationApproval = loanVerificationApproval;
	...
	public boolean isLoanVerificationApproval() {
		return isLoanVerificationApproval();
	}
	public void setLoanVerificationApproval(boolean loanVerificationApproval) {
		this.laonVerificationApproval = loanVerificationApproval;
	}
	...
	public String toString() {
		return "LoanApplication [applicationId=" + applicationId + ", applicationDate=" + applicationDate
				...
				+ loanApprovedAmount + ","
				+ ", financeVerificationApproval=" + laonVerificationApproval + ", adminApproval=" + adminApproval
				+ ", status=" + status + "]";
	}
