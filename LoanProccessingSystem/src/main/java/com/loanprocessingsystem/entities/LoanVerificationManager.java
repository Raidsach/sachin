...
@Entity
@ApiModel(value = "Loan Verification Officer Bean Class")
...
public class LoanVerificationManager extends User {
	...
	@NotEmpty(message = "Loan Verification Manager Name can't be empty!")
	...
	public LoanVerificationManager(String finOfficerName, String finOfficerContact) {
		super();
	...
	public String toString() {
		return "LoanVerificationManager [loanManagerName=" + loanManagerName+ ", loanManagerContact="
				+ loanManagerContact + "]";
	}
