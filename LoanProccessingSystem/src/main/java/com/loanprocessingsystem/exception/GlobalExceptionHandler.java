...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(LoanVerificationException.class)
	public ResponseEntity<String> handleFinanceException(LoanVerificationException ex) {
		HttpHeaders header = new HttpHeaders();
		header.add(desc, "Trying to get a Loan Verification Manager");
